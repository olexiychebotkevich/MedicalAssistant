            ...
            <Menu onClick={this.handleClick} selectedKeys={[this.state.current]} mode="horizontal" style={{ backgroundColor: 'rgb(174,214,187)' }}>
                ...
                {this.state.isAuthenticated ?
                    <Menu.Item style={{ float: 'right' }} >
                        <Button style={{ backgroundColor: 'rgb(157,181,176)', margin: '10px', fontFamily: 'Candara', border: '1px solid rgb(49, 112, 83)', color: 'rgb(49,112,83)' }} type="primary" onClick={this.logoutclick}>Logout</Button>
                    </Menu.Item>
                    : null}
            </Menu>
        );
