        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DoctorSpecialty = table.Column<string>(maxLength: 50, nullable: true),
                    ImagePath = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_tblDetailedDoctors", x => x.Id);
                    table.ForeignKey(
                        name: "FK_tblDetailedDoctors_AspNetUsers_Id",
                        column: x => x.Id,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ID = table.Column<int>(nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    Diagnos = table.Column<string>(maxLength: 300, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Receptionfeatures = table.Column<string>(maxLength: 200, nullable: true),
                    Counttimesaday = table.Column<int>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Medicine_tblRecipies_RecipeID",
                        column: x => x.RecipeID,
                        principalTable: "tblRecipies",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Restrict);
                });
